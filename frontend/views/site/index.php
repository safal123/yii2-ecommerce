    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                <img class="card-img-top" src="https://fakeimg.pl/250x100/" alt="Card image cap">
                <div class="card-body">
                    <h5 class="card-title text-center">$500</h5>
                    <p class="card-text">
                        Your listing will appear in the search results above Superhero listing
                        <br>
                        - List in any foreign country in top 3 categories of choice with the country flag.(3 months, can
                        edit the keywords)
                        <br>
                    ...
                    <input type="hidden" value="super-hero" name="type">
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Subscribe</button>
                    </div>
                    <?php ActiveForm::end() ?>
        ...
        <div class="col-md-4">
            <div class="card" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" value="hero" name="type">
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary">Subscribe</button>
                    </div>
                    <?php ActiveForm::end() ?>
